...
export function ProfileContent(){
    ...
    function toggleHour(hour : string){
        setSelecteHours((prev) => prev.includes(hour)? prev.filter( h => h !== hour) : [...prev, hour].sort() ) 
                                        ...
                                        <section className='py-4'>
                                            ...
                                            <div className='grid grid-cols-5 gap-2 '>
                                              {hours.map((hour) => (
                                                ...
                                                key={hour}
                                                variant="outline"
                                                className={cn('h-10', selecteHours.includes(hour) && ' border-2 border-emerald-500 text-primary')}
